...
export default function Dashboard({ stats }) {
    ...
    const cards = [
        [
            'Paket aktif',
            stats.activeWebServices,
            'Paket jasa yang tampil ke publik',
        ],
        [
            'Domain tersedia',
            stats.availableDomains,
            'Ekstensi domain siap dipesan',
        ],
    ...
    return (
        <>
            ...
            <AdminPageShell
                ...
                description="Ringkasan performa katalog dan pesanan ForDev."
            >
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Pantau alur pesanan dari masuk sampai selesai.
                        </CardDescription>
                    </CardHeader>
